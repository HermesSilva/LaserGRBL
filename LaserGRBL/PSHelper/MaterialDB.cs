...
namespace LaserGRBL.PSHelper
{
    ...
    partial class MaterialDB
    {
        partial class MaterialsDataTable
        {
            ...
            private IEnumerable<MaterialsRow> EnabledRows
            {
                get => this.Where(x => x.Visible);
            }
        ...
        {
            get => System.IO.Path.Combine(LaserGRBL.GrblCore.DataPath, "UserMaterials.psh");
        }
        public static string ServerFile
        {
            get => System.IO.Path.Combine(LaserGRBL.GrblCore.DataPath, "StandardMaterials.psh");
        }
    }
}
